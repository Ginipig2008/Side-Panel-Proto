...
const ActionPanel: React.FC<ActionPanelProps> = ({ onClose, showCloseButton = false, onAddClip, onReplaceClip, panelMode = 'default', setPanelMode, targetClip, setTargetClip, pendingClip, setPendingClip, selectedClip, setSelectedClip, onCancelPreview, onApplyPreview, handleAddDialogueClip, allDialogueClips }) => {
        ...
        <div className="h-full flex flex-col bg-white">
            ...
            <div className="border-b border-gray-100 px-4 py-3 flex-shrink-0 space-y-2">
                <div className="h-6 flex items-center justify-between">
                    <h2 className="font-semibold text-gray-800 text-base">Action</h2>
                                        ...
                                        onClick={() => {
                                            if (!isLeaf) {
                                                ...
                                                if (panelMode === 'replace' && targetClip) {
                                                    if (setPendingClip) setPendingClip({ name: item.name, category: 'Action' });
                                                    return;
                                                }
